...
import { FaHome, FaUser, FaTrain, FaCar, FaSignOutAlt } from 'react-icons/fa'; // Importing icons from react-icons
  ...
  return (
    <div className="sidebar p-3">
      <Nav className="flex-column">
        ...
        <Nav.Link onClick={handleLogout} className="nav-card" style={{ cursor: 'pointer' }}>
